...
namespace StarWarsApi.SchemaDefinition.Types
{
    public sealed class FilmType : ObjectGraphType<Film>
    {
        public FilmType()
        {
            ...
            Field(t => t.Producer).Name("Produzer").Description("A comma separated list of the producers");
            ...
            Field<ListGraphType<ReviewType>>("reviews", resolve: context => throw new NotImplementedException());
        }
    }
}